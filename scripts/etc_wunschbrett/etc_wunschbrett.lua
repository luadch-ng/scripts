--[[
    Imported from luadch/scripts (etc_wunschbrett_v0.2 (multi)) on 2026-05-05.
...
-- normalised on import: was "etc_wunschbrett_v0.2" upstream; matching lang
-- files were renamed to drop the "_v0.2" suffix during import.
local scriptname = "etc_wunschbrett"
