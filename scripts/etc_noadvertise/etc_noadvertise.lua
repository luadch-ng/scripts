--[[
    Imported from luadch/scripts (etc_noadvertise_v0.7 (multi)) on 2026-05-05.
...
--[[
    ...
    etc_noadvertise by pulsar
        ...
        v0.7:
            - remove forbidden/allowed table load on the "onBroadcast" Listener
            - code cleaning
    ...
    Note: use this script really carefully! PMs are "Private" Messages and they should be private.
          ...
          to spy PMs is lame! any hubowner has to bear responsibility to respect the privacy of the
          users. therefore keep fair, and respect the users.
...
hub.setlistener( "onStart", {},
    function()
        ...
        assert( hubcmd )
        assert( hubcmd.add( cmd, onbmsg, masterlevel ) )
        return nil
    end
)
