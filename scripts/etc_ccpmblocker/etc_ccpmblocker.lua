--[[
    Imported from luadch/scripts (etc_ccpmblocker2.0) on 2026-05-05.
    ...
    Normalised on import: scriptname "etc_ccpmblocker2.0" -> "etc_ccpmblocker"
    (drops version from identifier so the lang file path is clean and the
    upstream filename pattern doesn't carry a literal dot in scriptname).
]]--
