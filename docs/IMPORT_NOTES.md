...
[luadch-ng/luadch v3.1.2+](https://github.com/luadch-ng/luadch/releases/tag/v3.1.2).
...
shipped in v3.1.2 (closes [luadch-ng/luadch#88](https://github.com/luadch-ng/luadch/issues/88)).
